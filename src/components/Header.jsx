  ...
  return (
    <>
      <nav className="flex justify-between py-0 px-6 border-b border-veryLightPink border-solid sticky top-0 z-20 bg-white">
        ...
        {toggleMenuMobile && <MobileMenu logout={auth.logout} setOpen={setOpen} handleToggle={handleToggle} categories={categories} user={userData} handleCategory={handleCategory} />}
